...
from .calc_meridional_trsp import _parse_coords, meridional_trsp_at_depth, meridional_trsp_at_density
...
def calc_meridional_stf_density(ds, lat_vals, doFlip=True,
                                basin_name=None, coords=None, grid=None):
    """Compute the meridional overturning streamfunction in Sverdrups
    at specified latitude(s)
    ...
    # Creates an empty streamfunction
    ds_out = meridional_trsp_at_density(trsp_x, trsp_y, ds.RHOAnoma,
                                      lat_vals=lat_vals,
                                      coords=coords,
                                      basin_name=basin_name,
                                      grid=grid)
